...
class LLMOpenAI(LLM):
    ...
    def initialize(self) -> None:
        #self.client = AzureOpenAI(api_key=self._nlp_engine.get_property(nlp.OPENAI_API_KEY))
        #self.client = AzureOpenAI(azure_endpoint='https://uniludm.openai.azure.com/'
        self.client = AzureOpenAI(
        api_key=self._nlp_engine.get_property(nlp.OPENAI_API_KEY),  
        api_version="2024-08-01-preview",
        azure_endpoint = "https://uniludm.openai.azure.com/"
        )

#AZURE_OPENAI_ENDPOINT ="https://uniludm.openai.azure.com/"
#AZURE_OPENAI_API_KEY ="1f6459d45fde45879b45f48f23294bc2"
