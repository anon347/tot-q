...
class WebSocketPlatform(Platform):
    ...
    def _start_keepalive_thread(self, interval: int = 120):
        """Start a background thread that pings all connected clients periodically."""
        def keepalive_loop():
    ...
    def start(self) -> None:
        ...
        self.running = True
        self._start_keepalive_thread(interval=120)
