...
export declare const SESSION_RECORDING_URL_TRIGGER_STATUS = "$session_recording_url_trigger_status";
export declare const SESSION_RECORDING_EVENT_TRIGGER_ACTIVATED_SESSION = "$session_recording_event_trigger_activated_session";
export declare const SESSION_RECORDING_EVENT_TRIGGER_STATUS = "$session_recording_event_trigger_status";
