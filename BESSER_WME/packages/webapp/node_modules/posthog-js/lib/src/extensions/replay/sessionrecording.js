...
var SessionRecording = /** @class */ (function () {
    ...
    Object.defineProperty(SessionRecording.prototype, "canvasRecording", {
        get: function () {
            ...
            var canvasRecording_client_side = this.instance.config.session_recording.captureCanvas;
            ...
            var fps = (_d = (_c = canvasRecording_client_side === null || canvasRecording_client_side === void 0 ? void 0 : canvasRecording_client_side.canvasFps) !== null && _c !== void 0 ? _c : canvasRecording_server_side === null || canvasRecording_server_side === void 0 ? void 0 : canvasRecording_server_side.fps) !== null && _d !== void 0 ? _d : 0;
            var quality = (_f = (_e = canvasRecording_client_side === null || canvasRecording_client_side === void 0 ? void 0 : canvasRecording_client_side.canvasQuality) !== null && _e !== void 0 ? _e : canvasRecording_server_side === null || canvasRecording_server_side === void 0 ? void 0 : canvasRecording_server_side.quality) !== null && _f !== void 0 ? _f : 0;
            return {
                enabled: enabled,
    ...
    Object.defineProperty(SessionRecording.prototype, "urlTriggerStatus", {
        get: function () {
            ...
            var currentTriggerSession = (_a = this.instance) === null || _a === void 0 ? void 0 : _a.get_property(SESSION_RECORDING_URL_TRIGGER_ACTIVATED_SESSION);
            return currentTriggerSession === this.sessionId ? 'trigger_activated' : 'trigger_pending';
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SessionRecording.prototype, "eventTriggerStatus", {
        get: function () {
            var _a;
            if (this._eventTriggers.length === 0) {
                return 'trigger_disabled';
            }
            var currentTriggerSession = (_a = this.instance) === null || _a === void 0 ? void 0 : _a.get_property(SESSION_RECORDING_EVENT_TRIGGER_ACTIVATED_SESSION);
            return currentTriggerSession === this.sessionId ? 'trigger_activated' : 'trigger_pending';
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SessionRecording.prototype, "triggerStatus", {
        get: function () {
            var eitherIsActivated = this.eventTriggerStatus === 'trigger_activated' || this.urlTriggerStatus === 'trigger_activated';
            var eitherIsPending = this.eventTriggerStatus === 'trigger_pending' || this.urlTriggerStatus === 'trigger_pending';
            ...
            if (!this._onSessionIdListener) {
                this._onSessionIdListener = this.sessionManager.onSessionId(function (sessionId, windowId, changeReason) {
                    ...
                    if (changeReason) {
                        ...
                        (_b = (_a = _this.instance) === null || _a === void 0 ? void 0 : _a.persistence) === null || _b === void 0 ? void 0 : _b.unregister(SESSION_RECORDING_EVENT_TRIGGER_ACTIVATED_SESSION);
                        (_d = (_c = _this.instance) === null || _c === void 0 ? void 0 : _c.persistence) === null || _d === void 0 ? void 0 : _d.unregister(SESSION_RECORDING_URL_TRIGGER_ACTIVATED_SESSION);
                    }
                });
            }
        }
    ...
    SessionRecording.prototype.afterDecideResponse = function (response) {
        ...
        if ((_e = response.sessionRecording) === null || _e === void 0 ? void 0 : _e.urlBlocklist) {
            this._urlBlocklist = response.sessionRecording.urlBlocklist;
        }
        if ((_f = response.sessionRecording) === null || _f === void 0 ? void 0 : _f.eventTriggers) {
    ...
    SessionRecording.prototype._checkUrlTriggerConditions = function () {
        if (typeof window === 'undefined' || !window.location.href) {
            return;
        }
        var url = window.location.href;
        var wasBlocked = this.status === 'paused';
    ...
    SessionRecording.prototype._pauseRecording = function () {
        ...
        (_b = (_a = document === null || document === void 0 ? void 0 : document.body) === null || _a === void 0 ? void 0 : _a.classList) === null || _b === void 0 ? void 0 : _b.add('ph-no-capture');
    ...
    SessionRecording.prototype._resumeRecording = function () {
        ...
        this._urlBlocked = false;
        (_b = (_a = document === null || document === void 0 ? void 0 : document.body) === null || _a === void 0 ? void 0 : _a.classList) === null || _b === void 0 ? void 0 : _b.remove('ph-no-capture');
    ...
    SessionRecording.prototype._addEventTriggerListener = function () {
        ...
        this._removeEventTriggerCaptureHook = this.instance.on('eventCaptured', function (event) {
            // If anything could go wrong here it has the potential to block the main loop,
            // so we catch all errors.
            try {
                if (_this._eventTriggers.includes(event.event)) {
