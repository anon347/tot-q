...
export function getNativeImplementation(name, assignableWindow) {
    ...
    if (document && isFunction(document.createElement)) {
        try {
            ...
            logger.warn("Could not create sandbox iframe for ".concat(name, " check, bailing to assignableWindow.").concat(name, ": "), e);
        }
    }
...
export function getNativeMutationObserverImplementation(assignableWindow) {
