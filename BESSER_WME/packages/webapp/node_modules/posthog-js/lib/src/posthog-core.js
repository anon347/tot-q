...
import { isArray, isEmptyObject, isEmptyString, isFunction, isNumber, isObject, isString, isUndefined, } from './utils/type-utils';
...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._afterDecideResponse = function (response) {
        ...
        (_h = this.exceptionObserver) === null || _h === void 0 ? void 0 : _h.afterDecideResponse(response);
        (_j = this.deadClicksAutocapture) === null || _j === void 0 ? void 0 : _j.afterDecideResponse(response);
    };
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_d = this.persistence) === null || _d === void 0 ? void 0 : _d.set_property(USER_STATE, 'anonymous');
        (_e = this.sessionManager) === null || _e === void 0 ? void 0 : _e.resetSessionId();
        var uuid = this.config.get_device_id(uuidv7());
        this.register_once({
            distinct_id: uuid,
